      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div className="md:grid md:grid-cols-12 md:gap-8">
          ...
          <div className="md:col-span-9">
            ...
            <div className="mb-8">
              <h1 className="text-3xl sm:text-4xl font-light tracking-tight mb-2 bg-clip-text text-transparent bg-gradient-to-r from-blue-400 via-sky-300 to-purple-400">
            ...
            <section id="power" className="scroll-mt-24 rounded-2xl border border-white/10 bg-gray-900/50 backdrop-blur p-5 mb-8">
              <h2 className="text-xl font-light tracking-tight text-white mb-2">Power and batteries</h2>
            ...
            <section id="unlock" className="scroll-mt-24 rounded-2xl border border-white/10 bg-gray-900/40 backdrop-blur p-6 mb-6">
              <h2 className="text-2xl font-light tracking-tight text-white mb-4">1) Unlock it</h2>
            ...
            <section id="launcher" className="scroll-mt-24 rounded-2xl border border-white/10 bg-gray-900/40 backdrop-blur p-6 mb-6">
              <h2 className="text-2xl font-light tracking-tight text-white mb-4">2) Launch the launcher</h2>
              <div className="space-y-4 text-gray-200">
                <div>
            ...
            <section id="open-calcai" className="scroll-mt-24 rounded-2xl border border-white/10 bg-gray-900/40 backdrop-blur p-6 mb-6">
              <h2 className="text-2xl font-light tracking-tight text-white mb-4">3) Open CALCAI</h2>
            ...
            <section id="wifi" className="scroll-mt-24 rounded-2xl border border-white/10 bg-gray-900/40 backdrop-blur p-6 mb-6">
              <h2 className="text-2xl font-light tracking-tight text-white mb-4">4) Connect Wi‑Fi / Hotspot</h2>
            ...
            <section id="camera" className="scroll-mt-24 rounded-2xl border border-white/10 bg-gray-900/40 backdrop-blur p-6 mb-6">
              <h2 className="text-2xl font-light tracking-tight text-white mb-4">Camera</h2>
            ...
            <section id="updates" className="scroll-mt-24 rounded-2xl border border-white/10 bg-gray-900/40 backdrop-blur p-6 mb-6">
              <h2 className="text-2xl font-light tracking-tight text-white mb-4">Updates</h2>
              <ul className="list-disc list-inside space-y-2 text-gray-200">
            ...
            <section id="debug" className="scroll-mt-24 rounded-2xl border border-white/10 bg-gray-900/40 backdrop-blur p-6">
              <h2 className="text-2xl font-light tracking-tight text-white mb-4">Debugging / Support</h2>
              <ol className="list-decimal list-inside space-y-2 text-gray-200">
